# This file is a modified version of https://github.com/tensorflow/models/blob/master/research/audioset/yamnet/params.py
# Property values and descriptions can be changed.
#
# ==============================================================================
...
"""Hyperparameters for all YAMNet based models and also the CRNN model. Not all parameters are used within each model."""
...
class Params:
  ...
  mel_max_hz: float = 7500.0 # upper limit for the human hearing, 7500.0 loses to many details
